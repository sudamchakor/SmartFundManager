...
export const taxExpenseCategories = [
  {
    ...
    description: "Rent paid for accommodation. Used to calculate HRA exemption.",
  ...
  },
  {
    ...
    description: "Interest component of an education loan EMI. No upper limit on amount.",
    applicableRegimes: ["old"],
  },
];
...
export const taxRules = {
  ...
  deductions: {
    sec80C: {
      limit: 150000,
      label: "Section 80C",
      description: "Combined limit for investments like EPF, PPF, LIC, ELSS, Home Loan Principal, etc.",
      applicableRegimes: ["old"],
    },
    sec80D: {
    ...
    sec24b: {
      limit: 200000,
      label: "Section 24(b)",
      description: "Deduction for interest on home loan for self-occupied property.",
      applicableRegimes: ["old"],
    },
    hra: {
      label: "HRA Exemption",
      description: "Calculated as minimum of: Actual HRA, Rent paid - 10% of Basic, or 40%/50% of Basic.",
      applicableRegimes: ["old"],
    },
    nps80CCD1B: {
        limit: 50000,
    ...
    sec80E: {
        label: "Section 80E",
        description: "Deduction for interest on education loan, no monetary limit for 8 years.",
        applicableRegimes: ["old"],
    },
    sec80TTA: {
        limit: 10000,
